...
INVERT      bpl _K_1                         ; 4d30 1005    
__K__       eor #$ff                         ; 4d32 49ff    
            clc                              ; 4d34 18      
            adc #$01                         ; 4d35 6901    
_K_1        rts                              ; 4d37 60      
...
_SUPPLY_4   lda LON                          ; 50d7 a5cb    
            ...
            lda LAT                          ; 50dc a5ca    
            sta SQY                          ; 50de 8d3706  
__L__       lda SQX                          ; 50e1 ad3606  adjacent square
            clc                              ; 50e4 18      
            ...
            cmp #$bf                         ; 5100 c9bf    
            beq _L_2                         ; 5102 f009    
_L_1        lda ZOC                          ; 5104 ad9406  
            cmp #$02                         ; 5107 c902    
            bcc _L_6                         ; 5109 901c    
            inc RFR                          ; 510b e6cc    Russian force ratio: local Russian strength
_L_2        inc RFR                          ; 510d e6cc    Russian force ratio: local Russian strength
            lda RFR                          ; 510f a5cc    Russian force ratio: local Russian strength
            cmp ACCLO                        ; 5111 c5c7    
            bcc _L_5                         ; 5113 9009    
_L_3        lsr CSTRNG,x                     ; 5115 5edd55  combat strengths
            bne _L_4                         ; 5118 d003    
            jmp DEAD                         ; 511a 4cab51  

_L_4        rts                              ; 511d 60      

_L_5        lda SKREST/RANDOM                ; 511e ad0ad2  Reset serial port status register / Random byte
            and #$02                         ; 5121 2902    
            tay                              ; 5123 a8      
            jmp __L__                        ; 5124 4ce150  

_L_6        ldy HOMEDR                       ; 5127 ac9306  
            lda LON                          ; 512a a5cb    
            cpy #$01                         ; 512c c001    
            bne _L_7                         ; 512e d00b    
            cmp #$ff                         ; 5130 c9ff    
...
_BRKCHK_1   lda MSTRNG,x                     ; 51e0 bd3e55  muster strengths
            ...
            sec                              ; 51eb 38      
            sbc TEMPR                        ; 51ec e5c5    
__M__       cmp CSTRNG,x                     ; 51ee dddd55  combat strengths
            bcc _M_1                         ; 51f1 900a    
            lda #$ff                         ; 51f3 a9ff    
...
_O_5        inx                              ; 7057 e8      
            cpx #$37                         ; 7058 e037    
            bne _O_2                         ; 705a d0db    
_O_6        lda CORPSX,x                     ; 705c bd0054  longitude of all units
            sta TEMPR                        ; 705f 85c5    
...
_O_9        inx                              ; 707b e8      
            ...
            bcs _O_10                        ; 7085 b002    
            lda #$00                         ; 7087 a900    
_O_10       ldx #$03                         ; 7089 a203    
_O_11       ldy MOSCOW,x                     ; 708b bcea71  
            beq _O_12                        ; 708e f008    
            clc                              ; 7090 18      
...
_FINI_2     stx ARMY                         ; 70d7 86c2    
            jsr CALCEXEC                     ; 70d9 20d172  init calc EXEC,x for next order (was DINGO)
            dex                              ; 70dc ca      
            bne _FINI_2                      ; 70dd d0f8    
__P__       ldx #$9e                         ; 70df a29e    
__Q__       stx ARMY                         ; 70e1 86c2    
...
_Q_1        lda EXEC,x                       ; 70f9 bd616d  unit execution times
            bmi _Q_4                         ; 70fc 3045    
            ...
            bcs _Q_3                         ; 712e b008    
            bcc _Q_5                         ; 7130 9014    
_Q_2        lda ARMY                         ; 7132 a5c2    
            cmp #$37                         ; 7134 c937    
            bcs _Q_5                         ; 7136 b00e    
_Q_3        ldx ARMY                         ; 7138 a6c2    
            lda TICK                         ; 713a ad2e06  
            clc                              ; 713d 18      
            adc #$02                         ; 713e 6902    
            sta EXEC,x                       ; 7140 9d616d  unit execution times
_Q_4        jmp __R__                        ; 7143 4cd271  

_Q_5        jsr COMBAT                       ; 7146 20d84e  
            lda VICTRY                       ; 7149 ad9706  
            beq _Q_4                         ; 714c f0f5    
            bne _Q_7                         ; 714e d02e    
_Q_6        ldx ARMY                         ; 7150 a6c2    
...
_Q_7        jsr SWITCH                       ; 717e 20ef79  
            ...
            ldy #$03                         ; 71ac a003    
_Q_8        lda CORPSX,x                     ; 71ae bd0054  longitude of all units
            ...
            bcc _Q_9                         ; 71c2 9002    
            lda #$00                         ; 71c4 a900    
_Q_9        sta MOSCOW,y                     ; 71c6 99ea71  
_Q_10       dey                              ; 71c9 88      
            bpl _Q_8                         ; 71ca 10e2    
            jsr CALCEXEC                     ; 71cc 20d172  init calc EXEC,x for next order (was DINGO)
            jsr STALL                        ; 71cf 200072  
__R__       ldx ARMY                         ; 71d2 a6c2    
            dex                              ; 71d4 ca      
            beq _R_1                         ; 71d5 f003    
            jmp __Q__                        ; 71d7 4ce170  

_R_1        inc TICK                         ; 71da ee2e06  
            lda TICK                         ; 71dd ad2e06  
            cmp #$20                         ; 71e0 c920    
            beq _R_2                         ; 71e2 f003    
            jmp __P__                        ; 71e4 4cdf70  

_R_2        jmp NEWTRN                       ; 71e7 4c9a6e  
...
_TERRB_4    cmp CORPSY,x                     ; 729d dd9f54  latitude of all units
            beq _S_1                         ; 72a0 f00a    
__S__       dex                              ; 72a2 ca      
...
_S_1        lda LON                          ; 72ac a5cb    
            ...
            bcc _S_3                         ; 72bf 9007    
            beq _S_3                         ; 72c1 f005    
_S_2        lda LAT                          ; 72c3 a5ca    
            jmp __S__                        ; 72c5 4ca272  

_S_3        stx UNITNO                       ; 72c8 86c3    
            lda SWAP,x                       ; 72ca bd7c56  terrain code underneath unit
            sta TRNCOD                       ; 72cd 8d2b06  
            rts                              ; 72d0 60      

CALCEXEC    ldx ARMY                         ; 72d1 a6c2    init calc EXEC,x for next order (was DINGO)
...
__T__       lda CORPSX,x                     ; 72de bd0054  longitude of all units
            sta LON                          ; 72e1 85cb    
...
VBISRV      lda #$ff                         ; 7400 a9ff    vertical blank interrupt service
            nop                              ; 7402 ea      
...
_VBISRV_4   lda GRAFP3                       ; 7446 ad10d0  Graphics shape for player 3
...
_VBISRV_9   jsr ERRCLR                       ; 74a8 205e7a  
...
_U_1        lda CHUNKX                       ; 75fe a5be    Cursor coords (pixel frame)
            ...
            bcc _U_3                         ; 760c 9007    
            beq _U_3                         ; 760e f005    
_U_2        lda CHUNKY                       ; 7610 a5bf    
            jmp __U__                        ; 7612 4cf275  

_U_3        lda #$00                         ; 7615 a900    
...
__V__       dey                              ; 7751 88      
            ...
            asl                              ; 7754 0a      
            asl                              ; 7755 0a      
            jmp __V__                        ; 7756 4c5177  

_V_1        ldy TEMP1                        ; 7759 a4bb    all purpose temp
            ...
            ldx #$00                         ; 7798 a200    
_V_2        lda MLTKRZ,x                     ; 779a bdf75f  maltakreuze shape
            cpy #$80                         ; 779d c080    
            bcs _V_3                         ; 779f b003    
