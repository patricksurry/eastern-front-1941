...
_A_7:       lda #$00                         ; 48fc a900
            ldy #$04                         ; 48fe a004
_A_8:       ldx LV,y                         ; 4900 be8406  . line value array
            cpx #$05                         ; 4903 e005
            beq _A_9                         ; 4905 f003
            clc                              ; 4907 18
            adc #$28                         ; 4908 6928
...
_COMBAT_4:  stx AUDC1 / POT1                 ; 4f10 8e01d2  . W: Audio ch1 ctrl / R: paddle 1
            ...
            lda CSTRNG,y                     ; 4f32 b9dd55  . combat strengths [don't we want defender index here?]
...
_COMBAT_5:  dex                              ; 4f36 ca
            ...
            lda #$ff                         ; 4f3c a9ff
_COMBAT_6:  ldx HMORDS,y                     ; 4f3e be755d  now adjust for defender's motion
